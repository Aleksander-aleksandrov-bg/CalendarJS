g_l = [];
g_l.MONTHS = ["Janaury", "February", "March", "April", "May", "June", "July", "August",
...
String.prototype.strpad = function () {
    ...
    //proverqva dali denq e ednocifreno chislo
};
...
};//proverqva dali se zarejda prez IE i ako da izpulnqva funcciqta za IE
...
};//ako tipa na dvata frototipa e funcciq gi vrushta
JsDatePick.prototype.setRepopulationDelegate = function (a) {
    if (typeof (a) == "function") {
        this.repopulationDelegate = a; return true;
    } return false;
};//ako a e funk go slaga kato delegat na prezarejdane
...
JsDatePick.prototype.resizeCalendar = function () {
    ...
    return true;
};//chrez tazi funcciq se resizeva kalendara
...
JsDatePick.prototype.populateFieldWithSelectedDate = function () {
    ...
    this.lastPickedDateObject.day = this.selectedDayObject.day;//posledniqt selektiran den 
...
JsDatePick.prototype.makeCalendar = function () {
    ...
    b = j.createElement("div"); this.setC(e, "JsDatePickBox");
    ...
    g.appendChild(o); g.appendChild(m);
    g.appendChild(i);
    if (this.oConfiguration.isStripped) {
        ...
        this.setC(k, "boxLeftWall"); this.setC(g, "boxRightWall");
    }
    e.appendChild(k);
...
JsDatePick.prototype.populateMainBox = function (h) {
    ...
    j = new Date(this.currentYear, n, 1, 1, 0, 0); a = j.getTime();
    ...
    while (j.getMonth() == n) {
        ...
        g.onmousedown = function () {
            ...
            if (parseInt(this.getAttribute("isToday")) == 1) {
                ...
                d.setC(this, "" + d.day + "." + d.month + "." + d.year + "");
                d.setC(this, "" + d.day + "." + d.month + "." + d.year + "");
                this.style.background = "url(" + d.oConfiguration.imgPath + i + "_dayDown.gif) left top no-repeat";
            }
        };
        ...
        if (this.isSelectedDay(j.getDate())) {
            ...
            if (parseInt(g.getAttribute("isToday")) == 1) {
                ...
                g.style.background = "url(" + this.oConfiguration.imgPath
                    + this.oConfiguration.cellColorScheme + "_dayDown.gif) left top no-repeat";
            }
            else {
                this.setC(g, "daDown");
                g.style.background = "url(" + this.oConfiguration.imgPath
...
JsDatePick.prototype.isSelectedDay = function (a) {
    if (this.flag_aDayWasSelected) {
        if (parseInt(a) == this.selectedDayObject.day && this.currentMonth
            == this.selectedDayObject.month && this.currentYear
            == this.selectedDayObject.year) { return true; }
        else { return false; }
    } return false;
};
...
JsDatePick.prototype.setDaySelection = function (a) {
    ...
    if (this.flag_DayMarkedBeforeRepopulation) {
        ...
        if (parseInt(this.lastMarkedDayObject.getAttribute("isToday")) == 1) {
            ...
            this.lastMarkedDayObject.style.background = "url("
                + this.oConfiguration.imgPath + b + "_dayNormal.gif) left top no-repeat";
        }
        else {
    ...
    if (parseInt(a.getAttribute("isToday")) == 1) {
        this.setC(a, "dayDownToday"); a.style.background = "url("
            + this.oConfiguration.imgPath + b + "_dayDown.gif) left top no-repeat";
    }
    else {
        this.setC(a, "dayDown");
...
JsDatePick.prototype.isToday = function (a) {
    ...
    if (a.getDate() == this.oCurrentDay.day && a.getMonth() == b && a.getFullYear()
        == this.oCurrentDay.year) { return true } return false;
};
...
JsDatePick.prototype.getDOMControlBar = function () {
    ...
    f.onmouseout = function () {
        var i, d;
        if (parseInt(this.getAttribute("isJsDatePickDisabled")) == 1) { return }
        i = this.parentNode; while (i.className != "controlsBar") {
            i = i.parentNode;
        }
    ...
    g.onmouseout = function () {
        ...
        while (i.className != "controlsBar") {
            i = i.parentNode;
        } d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber")); d.setTooltipText(""); d.setC(this, "monthBackwardButton")
    }; g.onmousedown = function () {
    ...
    a.onmouseover = function () {
        ...
        d = JsDatePick.getCalInstanceById(this.getAttribute("globalNumber"));
        d.setTooltipText(g_l.YEAR_BCK); d.setC(this, "yearBackwardButtonOver");
    };
